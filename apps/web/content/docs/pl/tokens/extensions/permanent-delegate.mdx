...
accountów mogą odwołać, stały delegat nie może być zmieniony ani usunięty przez
właścicieli token accountów. Stały delegat może transferować lub spalać tokeny w
dowolnym token accouncie tego mintu. Rola stałego delegata może zostać
