...
description:
  ...
  niiden julkisiin RPC-päätepisteihin, nopeusrajoituksiin ja käyttötapauksiin.
...
| ------------ | -------------------------------- | ---------------------------------- | ----------------------------------- |
| Mainnet      | `https://api.mainnet.solana.com` | Tuotantoympäristö                  | Vaatii SOL-tokeneita transaktioihin |
| Devnet       | `https://api.devnet.solana.com`  | Julkinen testaus ja kehitys        | Ilmainen SOL-airdrop testaukseen    |
| Testnet      | `https://api.testnet.solana.com` | Validaattorien ja kuormitustestaus | Mahdollisia käyttökatkoja           |
...
- Keskeiset erot Devnetin ja Mainnetin välillä:
  - Devnet-tokenit **eivät ole oikeita**
  - Devnet sisältää token faucetin airdropeja varten sovellustestaukseen
  - Devnet voi olla alttiina ledger-nollauksille
  - Devnet ajaa tyypillisesti samaa ohjelmistojulkaisuversiota kuin Mainnet
    Beta, mutta voi ajaa uudempaa minor-julkaisuversiota kuin Mainnet.
...
- Testnet-tokenit **eivät ole oikeita**
- Testnet voi olla alttiina ledger-nollauksille.
- Testnet sisältää token faucetin airdropeja varten sovellustestaukseen
- Testnet ajaa tyypillisesti uudempaa ohjelmistojulkaisuversiota kuin sekä
  Devnet että Mainnet
...
- Mainnetissä julkaistut tokenit ovat **oikeita** SOL-tokeneita
...
- `https://api.mainnet.solana.com` - Solana Labsin isännöimä API-solmuklusteri,
  kuormantasaajan tukema; nopeusrajoitettu
